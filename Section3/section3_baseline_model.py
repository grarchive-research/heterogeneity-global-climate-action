...
def greenGR_newnew5bis(E0, X0, gamma0, betax, betae, alpha1, delta, mu, a, T=1000):
    """
...
if __name__ == "__main__":
    ...
    plt.savefig('X_E_estimatedparameters_NoIAM.png', dpi=1200, format='png', bbox_inches='tight') 
    plt.show()
